...
function Home() {
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-800 dark:to-neutral-700 rounded-xl p-4 sm:p-6 md:p-8 text-center shadow-lg border border-neutral-200 dark:border-neutral-600 animate-slide-up" style={{ animationDelay: '0.2s', opacity: 0, animationFillMode: 'forwards' }}>
