function Contact() {
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-neutral-900">Contact Us</h1>
      <p className="text-base sm:text-lg text-neutral-700 mb-6 sm:mb-8 leading-relaxed">
        Have questions? We'd love to hear from you. Send us a message and we'll respond as soon as possible.
      </p>
      <form className="space-y-4 sm:space-y-6 bg-white p-5 sm:p-6 rounded-xl shadow-lg border border-neutral-200">
        <div>
          ...
          <input
            ...
            id="name"
            name="name"
            className="w-full px-3 py-2 sm:px-4 sm:py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm sm:text-base transition-all"
